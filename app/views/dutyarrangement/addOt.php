...
<body class="add-employee-body">
	...
	<main>
		...
		<form action="<?php echo URLROOT;?>/OtManagementController/addOtPage" method="post" class="userform" id="form"  >
					...
					<div class="content-form pb-0">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="card">
									<div class="card-header"><h2>Add a OT<h2></div>
					...
					<div class="row">          
						<div class="col">
							<a href="<?php echo URLROOT;?>OtManagementController/otManagement"><button class="backBtn">Back</button></a>
						</div>
					</div>
