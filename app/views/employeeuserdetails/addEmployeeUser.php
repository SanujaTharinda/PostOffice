...
<body class="add-employee-body">
	...
	<main>
        <form action="<?php echo URLROOT; ?>EmployeeUserDetailsController/addEmployeeUser" method="post" class="userform" id="form"  >
					...
					<div class="content-form pb-0">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="card">
									<div class="card-header"><h2>Add Employee User Form<h2></div>
