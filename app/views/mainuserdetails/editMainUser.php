...
<body class="edit-employee-body">
    ...
    <main>
        ...
        <form action="<?php echo URLROOT; ?>MainUserDetailsController/editMainUserDetails" id="editMainUserForm" method="post" class="userform" >
                    ...
                    <div class="content-form pb-0">
                        <div class="animated fadeIn">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header"><h2>Edit Main USer Form<h2></div>
		...
		<script src="https://code.jquery.com/jquery-3.5.1.js" integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc=" crossorigin="anonymous"></script>
	  	<script src="<?php echo URLROOT; ?>public/js/mainUser.js"></script>
